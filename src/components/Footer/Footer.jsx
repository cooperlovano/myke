        ...
        <div>
            <footer className='bg-neutral-800 text-white py-12'>
                <div className='max-w-screen-xl mx-auto p-4 grid md:grid-cols-2 grid-cols-1 lg:grid-cols-3 gap-6 py-'>
                    {!pathname.startsWith("/docs") && menuItems.map((item, index) => (
                    ...
                    {pathname.startsWith("/docs") && 
                        <div className='mb-4'>
                        <span className='font-bold block mb-4'>Rechtliches</span>
                            <ul className='list-none flex flex-col gap-2 opacity-80'>

                                <li >
                                    <Link passHref legacyBehavior href={"/impressum"}>
                                        <a className='text-white hover:text-primary-500'>Impressum</a>
                                    </Link>
                                </li>
